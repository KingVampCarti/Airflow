...
def dannnn_xray_flow():
    ...
    get_data = KubernetesPodOperator(
        ...
        cmds=["/bin/bash", "-c", "--",
              f"cd {DATA_PATH} && curl -O 'https://astro_datasets.s3.eu-central-1.amazonaws.com/xray_data_2_class.tgz' && tar -xzf xray_data_2_class.tgz"],
        **k8s_config
    )
    ...
    def update_streamlit():
        ...
        url = 'https://raw.githubusercontent.com/KingVampCarti/Airflow/main/include/code/streamlit_app.py'
